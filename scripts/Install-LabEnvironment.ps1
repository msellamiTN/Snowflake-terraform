...
Write-Host ""
if ($allOk) {
    Write-Host "🎉 Tous les outils sont installés ! Vous pouvez commencer le Module 0." -ForegroundColor Green
    Write-Host "   Ouvrez le premier module : code student-track\module-00-environment\module.md" -ForegroundColor Green
} else {
